...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  if (this.sequence.indexOf(tile.value) === -7) classes.push("tile-super");
...
KeyboardInputManager.prototype.listen = function () {
  ...
  this.bindButtonPress(".resequence-button", this.resequence);
...
KeyboardInputManager.prototype.resequence = function (event) {
  event.preventDefault();
  this.emit("resequence");
};
